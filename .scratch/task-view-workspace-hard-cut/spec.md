...
**Status:** implemented; real-app smoke pending
...
- 真实 Tauri 最小 smoke：逐页切换 Default View，验证按下立即反馈；从 Standalone 与 Project 各保存一个 Saved View 并重新打开；验证 clean/dirty FilterBar；打开 `/views` 库与 Saved 详情。
