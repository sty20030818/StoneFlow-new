...
**实施与证据：** [02 验证记录](../02-verification.md)。实现、真实 Router/Query/mock IPC 组合、浏览器几何和根级检查已通过；实际 Tauri 原场景尚未验收。
...
- [ ] 在可操作的实际 Tauri 主窗口初验用户原场景，证据不足则明确未完成；整包原生结案仍由 09 汇总。修订 A2 与 task-workspace/View 文档中的职责冲突，相关消费者同票收口。
