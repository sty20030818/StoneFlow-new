...
import { isRememberableShellPath, normalizeShellMemoryPath } from './memory'
import { parseShellRoute, type ShellRoute } from './shellLocation'
import { getSectionLabel, getSpaceLabel, type ShellProjectLink } from '@/layout/config'
import type { Scope, Space } from '@/shared/types'

/**
 * 会话最近浏览条目的纯函数：建 entry、归约列表。
 * Hook 与 browser history 副作用见下方 useShellSessionRouteHistory。
 */
