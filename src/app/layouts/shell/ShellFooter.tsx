...
export function ShellFooter() {
	return (
		<footer className='relative z-32 isolate flex h-7 shrink-0 items-center justify-between gap-4 overflow-x-clip border-t border-sf-border-subtle/60 bg-sf-shell px-3'>
			{/* 左：同步 */}
