...
import { openStartupFallback, openTaskDetail } from '@/app/navigation/intents'
	...
	return (
		...
		>
			<SyncStatusProvider>
				...
				<ShellOverlays
					closeCustomDateDialog={closeCustomDateDialog}
					closeProjectCreateDialog={closeProjectCreateDialog}
					closeTaskCreateDialog={closeTaskCreateDialog}
					createDialogType={createDialogType}
					currentScope={currentScope}
					customDateDialog={customDateDialog}
					defaultCreateSpaceId={defaultCreateSpaceId}
					projectOptions={projectOptions}
					projectsLoading={sidebarProjects.status === 'loading'}
					selectedSpaceId={selectedSpaceId}
					setSelectedSpaceId={setSelectedSpaceId}
					shouldDelayTaskCreateDialog={shouldDelayTaskCreateDialog}
					spaces={spaces}
					taskCreateDraft={taskCreateDraft}
					taskCreatePresentation={taskCreatePresentation}
					toggleTaskCreatePresentation={toggleTaskCreatePresentation}
				/>
				<ShellFooter />
			</SyncStatusProvider>
		</SidebarProvider>
