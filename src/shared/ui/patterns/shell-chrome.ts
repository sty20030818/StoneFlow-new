/**
 * Shell chrome 微模式：header/sidebar 通用的 icon 与小组布局。
 */
...
export const shellChromeWindowControlClass =
	'h-10 w-10 rounded-md bg-transparent shadow-none ring-0 text-sf-shell-text-secondary hover:bg-sf-shell-hover-strong hover:text-foreground focus-visible:ring-0'
...
export const shellChromeCommandDialogClass =
	'max-w-2xl border border-border/80 bg-popover/98 shadow-(--sf-shadow-float)'

export const shellChromeNavCircleButtonClass =
	'rounded-full bg-transparent text-sf-shell-text-secondary shadow-none hover:bg-sf-shell-hover hover:text-foreground'

export const shellChromeNavCircleButtonExpandedClass =
	'aria-expanded:bg-sf-shell-hover focus-visible:ring-0'
