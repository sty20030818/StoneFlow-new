 ...
 * - 调试代码块/折叠容器
 */
export const activityDebugFieldLabelClass =
	'text-[11px] font-medium uppercase tracking-[0.06em] text-sf-shell-text-tertiary'

export const activityDebugMetaRowClass =
