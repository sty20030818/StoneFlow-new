...
export const taskCommands: Command[] = [
	...
	{
		id: COMMAND_IDS.taskMoveToProject,
		title: '移动任务到项目',
		category: 'move',
		scope: ['task-list'],
		description: '打开任务移动 scoped picker，选择目标项目。',
		keywords: ['task', 'move', 'project', '移动', '项目'],
		getPriority: () => 40,
		run: () => {},
	},
	{
		id: COMMAND_IDS.taskMoveToInbox,
		title: '移动任务到收件箱',
		category: 'move',
		scope: ['task-list'],
		description: '将当前任务移动到 Inbox。',
		keywords: ['task', 'move', 'inbox', '移动', '收件箱'],
		getPriority: () => 40,
		run: () => {},
	},
	{
		id: COMMAND_IDS.taskMoveToNoProject,
		title: '移动任务到独立事项',
		category: 'move',
		scope: ['task-list'],
		description: '将当前任务移出项目，设为独立事项。',
		keywords: ['task', 'move', 'no project', '独立事项'],
		getPriority: () => 40,
		run: () => {},
	},
]
