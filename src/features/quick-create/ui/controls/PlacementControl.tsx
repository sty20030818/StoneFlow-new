...
type PlacementControlProps = {
	...
	disabled?: boolean
	label: string
	options: QuickCreateProjectOption[]
	value: QuickCreatePlacement
	onOpenChange: (open: boolean) => void
	onPlacementChange: (placement: QuickCreatePlacement) => void
}
...
export function PlacementControl({
	...
	return (
		<DropdownMenu onOpenChange={onOpenChange} open={open}>
			...
			<DropdownMenuContent align='end' className={`w-60 ${quickCreateMenuContentClass}`}>
