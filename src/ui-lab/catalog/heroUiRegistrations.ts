...
const OSS_PRODUCTION_USAGE = [
	...
	['src/features/lifecycle/components/LifecycleBoard.tsx', ['Alert', 'Button', 'Chip', 'Skeleton']],
	...
	['src/features/project/components/ProjectBoard.tsx', ['Alert', 'Button', 'Chip', 'Skeleton']],
	[
