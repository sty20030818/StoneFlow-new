...
export const TICKET_05_SAMPLES = [
	{
		...
		owner: 'shared/RowShell（密度与状态外壳）+ 调用方（交互语义）+ 全局主题（视觉）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（菜单结构、焦点与选择）+ 产品调用方（命令）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（列表框结构、选择与键盘导航）+ 全局主题（视觉）',
	...
	},
	{
		...
		owner: 'HeroUI Pro（GridList 结构、选择与 ItemAction）+ 产品调用方（动作）',
		states: 'Rest、Selected、Trailing Action、Disabled、长中文、Keyboard Focus Visible',
	...
	},
	{
		...
		owner: 'HeroUI OSS（表格结构、选择与滚动容器）+ UI Lab fixture（只读数据）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（TagGroup 选择与移除）+ 全局主题（视觉）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（Chip）+ 产品调用方（状态语义）+ 全局主题（视觉）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（Badge 与 Anchor）+ 产品调用方（计数语义）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（Avatar 与 fallback）+ 产品调用方（人物语义）',
	...
	},
	{
		...
		owner: 'UI Lab fixture（本地状态）+ shared/RowShell（外壳）+ HeroUI OSS（控件）',
	...
	},
	{
		...
		owner: 'UI Lab fixture（折叠状态）+ HeroUI OSS（按钮与 Chip）',
	...
	},
	{
		...
		owner: 'UI Lab 最小组合 + shared/RowShell；features/task 运行时仅 Main 验证',
