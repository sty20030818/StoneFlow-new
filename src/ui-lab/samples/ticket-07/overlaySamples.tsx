...
export const TICKET_07_SAMPLES = [
	{
		...
		owner: 'HeroUI OSS（结构/触发）；共享 Tooltip recipe 仅真实应用验证',
	...
	},
	{
		...
		owner: 'HeroUI OSS（结构/焦点）；产品动作仅真实应用验证',
	...
	},
	{
		...
		owner: 'HeroUI OSS（结构/焦点）；产品表单仅真实应用验证',
	...
	},
	{
		...
		owner: 'HeroUI Pro（结构/焦点）；产品上下文动作仅真实应用验证',
	...
	},
	{
		...
		owner: 'HeroUI OSS（结构/焦点）；产品提交与错误处理仅真实应用验证',
	...
	},
	{
		...
		owner: 'HeroUI OSS（结构/焦点）+ features/danger-confirm（产品约定）',
	...
	},
	{
		...
		owner: 'HeroUI Pro（结构/焦点）；产品容器切换仅真实应用验证',
	...
	},
	{
		...
		owner: 'UI Lab 最小组合；features/entity-detail 是真实产品 owner',
