...
export const TICKET_06_SAMPLES = [
	{
		...
		owner: 'HeroUI Pro / OSS（反馈结构）· UI Lab fixture（本地状态）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（语义、队列与 Portal 生命周期）',
	...
	},
	{
		...
		owner: 'HeroUI OSS（状态语义）· UI Lab fixture（结果控制）',
	...
	},
	{
		...
		owner: 'Launcher feature（场景契约）· UI Lab fixture（可移植界面）',
