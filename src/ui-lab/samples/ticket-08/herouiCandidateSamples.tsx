...
export const TICKET_08_SAMPLES: readonly UiLabSample[] = [
	...
	},
	{
		...
		view: 'heroui',
		category: '替换候选',
		description: '复核原搜索 Input 替换假设；当前代码已使用 SearchField，不据此追加生产迁移。',
		keywords: ['searchfield', 'search field', '搜索', 'input', '替换候选'],
		owner: 'HeroUI OSS',
		source: '@heroui/react@3.2.4',
		coverage: 'rendered',
	...
	},
	{
		...
		view: 'heroui',
		category: '替换候选',
		description: '评估 DatePicker 是否能收敛当前 Calendar + Popover/Modal 日期组合。',
		keywords: ['datepicker', 'date picker', '日期', 'calendar', 'popover', 'modal', '替换候选'],
		owner: 'HeroUI OSS',
		source: '@heroui/react@3.2.4',
		coverage: 'rendered',
