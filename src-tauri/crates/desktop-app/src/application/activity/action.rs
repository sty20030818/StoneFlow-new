...
impl ActivityAction {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::SpaceNameUpdated => "space.name.updated",
            Self::SpaceIconUpdated => "space.icon.updated",
            Self::SpaceColorUpdated => "space.color.updated",
            Self::SpaceDefaultChanged => "space.default.changed",
            Self::SpaceArchived => "space.archived",
            Self::SpaceRestored => "space.restored",
            Self::SpaceDeleted => "space.deleted",
            Self::SpacePermanentlyDeleted => "space.permanently_deleted",
            Self::SpaceSortChanged => "space.sort.changed",
