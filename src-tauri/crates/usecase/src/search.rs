...
pub trait SearchSpaceReader {
    async fn list_visible_spaces(&self) -> Result<Vec<SearchSpaceRecord>, UsecaseError>;
}
...
pub trait SearchProjectReader {
    ...
    ) -> Result<Vec<SearchProjectRecord>, UsecaseError>;
}
...
pub trait SearchTaskReader {
    ...
    ) -> Result<Vec<SearchTaskRecord>, UsecaseError>;
    ...
    T: SearchTaskReader,
{
    ...
    ) -> Result<SearchEntitiesResultDto, UsecaseError> {
    ...
    ) -> Result<Vec<SearchTaskItemDto>, UsecaseError> {
