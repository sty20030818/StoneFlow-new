...
pub struct QuickCreateSpaceCandidate {
    pub id: String,
    pub is_default: bool,
}
...
pub fn resolve_default_space_id(
    ...
    spaces: &[QuickCreateSpaceCandidate],
...
mod tests {
    ...
    fn candidate(id: &str, is_default: bool) -> QuickCreateSpaceCandidate {
        QuickCreateSpaceCandidate {
            id: id.to_owned(),
            is_default,
        }
    }
