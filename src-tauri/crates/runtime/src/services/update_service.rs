...
pub type RuntimeUpdateService =
    stoneflow_application::update::UpdateService<TauriUpdateAdapter, StoreUpdateSettingsAdapter>;
...
pub fn build_update_service(app: &tauri::AppHandle) -> RuntimeUpdateService {
    ...
    stoneflow_application::update::UpdateService::new(adapter, settings_adapter)
}
