...
4. HeroUI 管理标准组件交互和视觉；StoneFlow 只保留产品语义、业务状态、Tauri 原生窗口几何、Sidebar 已确认三态、Task Detail 基于窗口 `1024px` 断点的 Aside / Sheet 容器合同、TaskBoard 特殊虚拟几何与 Command/selection 产品合同。
